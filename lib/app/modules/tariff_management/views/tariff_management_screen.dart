...
class TariffManagementScreen extends GetView<TariffManagementController> {
  const TariffManagementScreen({Key? key, required this.userType})
      : super(key: key);
